# Antigravity Awesome Skills — Master Index

**Installed:** 2026-04-05
**Total Skills:** 1372
**Source:** ~/antigravity-awesome-skills/skills/
**Synced to:**
- Claude Code: ~/.claude/skills/ (1360 symlinks)
- DeerFlow: ~/Desktop/Deerflow/deer-flow/.agent/skills/ (1360 symlinks)
- JARVIS: ~/Desktop/LandWise/Jarvis/skills/ (1360 symlinks)
- OpenClaw: ~/.nvm/.../openclaw/skills/ (1360 symlinks)
- Obsidian: this vault (1372 notes)

---

## Top Skills for LandWise Workflows

| Skill | Use Case |
|---|---|
| [[brainstorming]] | Strategic planning, ideation |
| [[deep-research]] | Land/property research, lead research |
| [[documentation]] | Reports, runbooks, SOPs |
| [[security-auditor]] | Code/config review |
| [[code-refactoring]] | Codebase improvements |
| [[agent-orchestrator]] | Multi-agent coordination |
| [[ai-product]] | Product strategy |
| [[airtable-automation]] | CRM automation |
| [[activecampaign-automation]] | Email/CRM automation |
| [[ad-creative]] | Marketing content |
| [[data-analysis]] | CRM and lead data |
| [[agent-tool-builder]] | Build new JARVIS tools |

---

## Full Skill Catalog (1372 skills)
...
---
*To update: re-run antigravity install script*
